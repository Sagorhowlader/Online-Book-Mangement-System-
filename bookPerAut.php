<?php
	...
	// connect database
	$conn = db_connect();
	$autorname = getauthorname($conn, $authorid);

	$query = "SELECT book_isbn, book_title, book_image FROM books WHERE authorid = '$authorid'";
...
?>
	<p class="lead"><a href="author.php">Author</a> > <?php echo $authorName; ?></p>
